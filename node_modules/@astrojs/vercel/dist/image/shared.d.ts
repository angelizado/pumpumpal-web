...
export declare function getAstroImageConfig(images: boolean | undefined, imagesConfig: VercelImageConfig | undefined, command: string, astroImageConfig: AstroConfig['image']): {
    image: {
        service: {
            entrypoint: string;
